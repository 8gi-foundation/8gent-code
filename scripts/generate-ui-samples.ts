			...
			messages: [
				{
					role: "system",
					content:
						"You are an expert frontend developer. Output ONLY a complete HTML file. No explanations. No markdown fences. Just the HTML starting with <!DOCTYPE html>.",
				},
