...
const ModelCard = ({
	...
	<Box flexDirection="column" marginLeft={2}>
		...
		<Text dimColor>
			{" "}
			{model.size} • Min {model.minRAM}GB RAM
		</Text>
...
const InstallerApp = () => {
	...
	const detectSystem = async () => {
		try {
			...
			const recommended =
				FALLBACK_MODELS.find((m) => m.minRAM <= memoryGB) ||
		...
		<Box flexDirection="column" padding={1}>
				...
				<Box flexDirection="column" alignItems="center">
					...
					>
						<Text>
							...
							— the free, local AI coding assistant.
						</Text>
					</Box>
					...
					<Box flexDirection="column" marginY={1} marginLeft={2}>
						<Text>
							{" "}
							<Text color="green">✓</Text> Detect your hardware
						</Text>
						<Text>
							{" "}
							<Text color="green">✓</Text> Install Ollama (if needed)
						</Text>
						<Text>
							{" "}
							<Text color="green">✓</Text> Download a coding model
						</Text>
						<Text>
							{" "}
							<Text color="green">✓</Text> Configure 8gent
						</Text>
					</Box>
			...
			{step === "error" && (
				<Box flexDirection="column" alignItems="center">
					...
					<Text dimColor>Please try again or install manually.</Text>
					<Text color="yellow" marginTop={2}>
						Press <Text bold>Q</Text> to exit
					</Text>
				</Box>
