...
3. **Promotion criteria** - add a unit test suite, wire into at least one consumer (memory store or agent), then move to `packages/tools/token-splitter.ts` as a first-class tool.
