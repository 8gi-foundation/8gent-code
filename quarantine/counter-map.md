...
- `clone()` - independent copy of the Counter
- `toObject()` - plain object snapshot (string-coerced keys)
...
3. Use in `benchmarks/autoresearch/harness.ts` to count tool-call frequencies per loop
