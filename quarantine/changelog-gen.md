...
- add worktree delegation benchmark [`742ac14`](https://github.com/8gi-foundation/8gent-code/commit/742ac14)

### Fixed

- fix auth race on session resume [`a1b2c3d`](https://github.com/8gi-foundation/8gent-code/commit/a1b2c3d)
```
