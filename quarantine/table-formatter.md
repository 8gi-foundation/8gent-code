...
2. Wire into the agent tool definitions in `packages/eight/tools.ts` as a display utility.
3. Use in memory health reports, benchmark dashboards, and agent output presenting tabular data.
