...
## Description
Validates JSON data against JSON Schema draft-07 subset definitions. Returns a structured result with a `valid` boolean and an `errors` array containing path-keyed messages for every constraint violation.
