...
| `formatCurrency(n, currency, locale?, decimals?)` | currency prefix | `$9.99`, `9,99 EUR` |
...
3. Currency display in any billing/pricing UI
4. Replace manual compact logic in `packages/proactive/` opportunity pipeline
