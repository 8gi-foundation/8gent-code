...
Generated: 2026-03-25T01:52:35.727Z
...
| other | `ErrorEntry` | packages/tools/error-catalog.ts | 8 |
| function | `lookupByCode` | packages/tools/error-catalog.ts | 78 |
| function | `searchErrors` | packages/tools/error-catalog.ts | 83 |
| function | `listCategory` | packages/tools/error-catalog.ts | 95 |
| function | `getCategories` | packages/tools/error-catalog.ts | 100 |
| function | `getAllErrors` | packages/tools/error-catalog.ts | 105 |
...
| function | `generateCompletion` | packages/tools/autocomplete.ts | 165 |
| type | `TranslationMap` | packages/tools/i18n.ts | 11 |
| type | `Locale` | packages/tools/i18n.ts | 12 |
| other | `I18nOptions` | packages/tools/i18n.ts | 14 |
| class | `I18n` | packages/tools/i18n.ts | 23 |
| function | `detectLocale` | packages/tools/i18n.ts | 126 |
| other | `Migration` | packages/tools/migrations.ts | 21 |
| other | `AppliedMigration` | packages/tools/migrations.ts | 29 |
| function | `getApplied` | packages/tools/migrations.ts | 87 |
| function | `getPending` | packages/tools/migrations.ts | 93 |
| function | `migrateUp` | packages/tools/migrations.ts | 100 |
| function | `migrateDown` | packages/tools/migrations.ts | 119 |
| function | `status` | packages/tools/migrations.ts | 142 |
| other | `TelemetryEvent` | packages/tools/telemetry.ts | 17 |
| other | `SessionSummary` | packages/tools/telemetry.ts | 25 |
| class | `TelemetryStore` | packages/tools/telemetry.ts | 45 |
| other | `LogRotationConfig` | packages/tools/log-rotation.ts | 13 |
| function | `rotateLogs` | packages/tools/log-rotation.ts | 90 |
...
| other | `BackupResult` | packages/tools/backup.ts | 35 |
| other | `RestoreResult` | packages/tools/backup.ts | 43 |
| function | `backup` | packages/tools/backup.ts | 70 |
| function | `restore` | packages/tools/backup.ts | 104 |
| function | `listBackups` | packages/tools/backup.ts | 126 |
...
| other | `ToolStatus` | packages/tools/system-info.ts | 8 |
| other | `NetworkCheck` | packages/tools/system-info.ts | 14 |
| other | `SystemReport` | packages/tools/system-info.ts | 20 |
| function | `collectSystemInfo` | packages/tools/system-info.ts | 133 |
| function | `formatReport` | packages/tools/system-info.ts | 146 |
...
| function | `queryMetaHistory` | packages/memory/meta-history.ts | 66 |
...
| other | `IssueScannerConfig` | packages/proactive/issue-scanner.ts | 20 |
| function | `scanIssues` | packages/proactive/issue-scanner.ts | 139 |
| other | `DailyDigest` | packages/proactive/issue-scanner.ts | 208 |
| function | `dailyDigest` | packages/proactive/issue-scanner.ts | 218 |
| function | `formatDigest` | packages/proactive/issue-scanner.ts | 234 |
...
### packages/self-autonomy (52)

| Kind | Name | File | Line |
|------|------|------|------|
| other | `MetaVersionInfo` | packages/self-autonomy/meta-versioning.ts | 17 |
| other | `MetaLogEntry` | packages/self-autonomy/meta-versioning.ts | 22 |
| function | `metaShow` | packages/self-autonomy/meta-versioning.ts | 36 |
| function | `metaHistory` | packages/self-autonomy/meta-versioning.ts | 42 |
| function | `metaLog` | packages/self-autonomy/meta-versioning.ts | 54 |
| function | `metaRollback` | packages/self-autonomy/meta-versioning.ts | 62 |
| function | `metaChangelog` | packages/self-autonomy/meta-versioning.ts | 84 |
| function | `formatMetaDisplay` | packages/self-autonomy/meta-versioning.ts | 108 |
| other | `TaskConfig` | packages/self-autonomy/hyperagent-config.ts | 36 |
| function | `loadTaskConfig` | packages/self-autonomy/hyperagent-config.ts | 129 |
| function | `saveTaskConfig` | packages/self-autonomy/hyperagent-config.ts | 140 |
| function | `ensureConfigs` | packages/self-autonomy/hyperagent-config.ts | 146 |
...
| other | `MutationProposal` | packages/self-autonomy/meta-mutation.ts | 25 |
| other | `MutationResult` | packages/self-autonomy/meta-mutation.ts | 32 |
| function | `proposeMutation` | packages/self-autonomy/meta-mutation.ts | 172 |
...
| other | `BenchmarkResult` | packages/validation/meta-eval.ts | 20 |
| other | `MetaEvalResult` | packages/validation/meta-eval.ts | 29 |
| function | `evaluateMetaChange` | packages/validation/meta-eval.ts | 62 |
| function | `getBaselineScore` | packages/validation/meta-eval.ts | 91 |
...
| function | `findDeadCode` | packages/validation/dead-code-finder.ts | 118 |
...
| other | `HealthReport` | packages/daemon/health-check.ts | 17 |
| function | `buildHealthReport` | packages/daemon/health-check.ts | 92 |
...
| other | `ShareGPTMessage` | packages/kernel/data-curator.ts | 17 |
| other | `ShareGPTConversation` | packages/kernel/data-curator.ts | 22 |
| other | `CurationStats` | packages/kernel/data-curator.ts | 31 |
| class | `DataCurator` | packages/kernel/data-curator.ts | 88 |
...
| const | `benchmark` | benchmarks/categories/abilities/evolution-learn.ts | 5 |
| const | `benchmark` | benchmarks/categories/abilities/worktree-parallel.ts | 5 |
| const | `benchmark` | benchmarks/categories/abilities/policy-compliance.ts | 5 |
| const | `benchmark` | benchmarks/categories/abilities/memory-recall.ts | 5 |
...
| const | `OsPitch` | apps/demos/src/scenes/OsPitch.tsx | 1264 |
| const | `HyperAgentSession` | apps/demos/src/scenes/HyperAgentSession.tsx | 29 |
| const | `BenchmarkDashboard` | apps/demos/src/scenes/BenchmarkDashboard.tsx | 28 |
...
| Kind | Name | File | Line |
|------|------|------|------|
| other | `ValidateEmailResult` | src/utils/validateEmail.ts | 7 |
| other | `EmailValidationResult` | src/utils/validate-email.ts | 5 |
