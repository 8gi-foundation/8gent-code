...
**Owner:** 8MO (Zara)
**Hard rule:** every post requires James's explicit per-post approval before publish. No auto-ship.
**Voice:** terse, declarative, dry. No emojis in customer copy. No em dashes anywhere.
**Brand:** never name Anthropic / OpenAI / Claude / GPT in customer-facing copy. Day 3 names competitors factually (Hermes, Codex) - that is the only exception.

---

## Day 0 - Friday 2026-05-22 - VIDEO LAUNCH
...
Attach: 60s master video. Native upload.
Pin to profile for 24h.
...
The whole loop runs on your laptop. No cloud, no API keys, no bill. The judge is a different local model from the executor on purpose - a system that grades itself isn't a system.
...
Built by the team at 8GI Foundation. Apache 2.0. 8gent.dev.
```
...
### Telegram announcement (post immediately after X confirms upload)
...
KittenTTS voice note attached: 15 second VO of the hook line, delivered by James's officer-voice rotation.

### IG / Threads / X follow-up at 22:00 IST (Day 0 close)

Single screenshot post. Before / after of a real Downloads folder. No video.

```
Six hours in. The verdict cards going around all say the same thing.

Done. Organized. Deduped. Flagged.
...
## Day 1 - Saturday 2026-05-23 - AIDHD ESSAY DROP
...
### Threads cross-post (10:05 IST)

```
The world calls it a discipline problem.
...
### LinkedIn cross-post (12:00 IST = post-lunch NA-EU overlap)
...
### IG channel cross-post (18:00 IST)
...
## Day 2 - Sunday 2026-05-24 - "WHY IT HAS TO BE LOCAL" DEEP-DIVE

Long-form drops on 8gent.world. Cross-posted as excerpts.
...
A goal-loop that quietly phones home is not local. It's just local-feeling.

Here's why we drew the line.

[8gent.world link]
```

### Threads (post at 11:05 IST)

```
Local-first isn't a vibe. It's a contract.
...
Attach: 15-second clip from launch video, the airplane-mode tilt-down with "Runs on the plane." stamp.
...
Theirs runs in the cloud or wherever you point the keys.
Ours runs on the plane.
...
Credit to NousResearch and OpenAI for moving the field. Ours runs on the plane.
...
[airplane mode tilt-down clip]
```

---

## Approval gates - cannot ship without James greenlight per post

| Day | Surface | Time (IST) | Approval needed by |
|-----|---------|------------|--------------------|
| 0 | X video | 14:00 Fri | 13:30 Fri |
| 0 | Threads video | 14:05 Fri | 13:30 Fri |
| 0 | LinkedIn video | 14:30 Fri | 14:00 Fri |
| 0 | IG channel video | 14:30 Fri | 14:00 Fri |
| 0 | Telegram broadcast | post-X | 13:45 Fri |
| 0 | Day 0 close screenshot | 22:00 Fri | 21:30 Fri |
| 1 | Substack publish | 09:00 Sat | 08:30 Sat |
| 1 | X cross-post | 10:00 Sat | 09:30 Sat |
| 1 | Threads cross-post | 10:05 Sat | 09:30 Sat |
| 1 | LinkedIn cross-post | 12:00 Sat | 11:30 Sat |
| 1 | IG channel cross-post | 18:00 Sat | 17:30 Sat |
| 2 | X deep-dive | 11:00 Sun | 10:30 Sun |
| 2 | Threads deep-dive | 11:05 Sun | 10:30 Sun |
| 2 | LinkedIn deep-dive | 13:00 Sun | 12:30 Sun |
| 3 | X competitive | 10:00 Mon | 09:30 Mon |
| 3 | Threads competitive | 10:05 Mon | 09:30 Mon |
| 3 | LinkedIn competitive | 12:00 Mon | 11:30 Mon |
| 3 | IG channel competitive | 18:00 Mon | 17:30 Mon |

All drafts pre-queued in 8MO mailbox 24h ahead with KittenTTS audio summary for review.

---

## Voice and don'ts

- Never write "successfully", "great news", "I've", "working on", "AI", "model", in customer-facing copy. Internal-only term `judge model` is OK in long-form because the alternative is technical fog.
- No em dashes. Hyphens or rewrites.
