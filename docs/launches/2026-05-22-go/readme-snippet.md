...
## /goal - autonomous goal-loop (local-first)
...
Commands: `/goal`, `/goal status`, `/goal stop`, `/goal resume`, `/subgoal`.

[Read the architecture note: Why /goal has to be local.](https://8gent.world/posts/why-go-has-to-be-local)
