...
| No team member full names | In public content, reference roles ("our CTO", "the security officer") not individual names. The Seed (8GI Foundation) is the exception as a public founder. |
