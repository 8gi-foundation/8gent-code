...
Step 7: Git & GitHub Configuration
  ...
  - Request GitHub org invitation acceptance (8gi-foundation/8gi-circle)
...
| Quarantine PRs | GitHub (8gi-foundation org) | Code is visible but authored by the member's choice (real name or pseudonym) |
...
### Organisation: `8gi-foundation`

```
8gi-foundation (GitHub Org)
...
| Team | Members | Access |
|------|---------|--------|
| `@8gi-foundation/core` | James | Admin on all repos |
| `@8gi-foundation/cto` | Rishi | Maintain on all public repos, Admin on protocol |
| `@8gi-foundation/circle` | All circle members | Write on public repos, Read on private |
| `@8gi-foundation/reviewers` | James + trusted engineers | Required reviewers for PRs |
...
Branch: main
  ...
  - Required approving reviews: 1 (from @8gi-foundation/reviewers)
  ...
  - Restrict who can push to matching branches:
    - @8gi-foundation/core only (no direct push by circle members)
...
packages/tools/             @8gi-foundation/reviewers
packages/memory/            @8gi-foundation/core
packages/permissions/       @8gi-foundation/core
packages/self-autonomy/     @8gi-foundation/core
scripts/                    @8gi-foundation/core

# CI/CD changes always need James
.github/                    @8gi-foundation/core
```
...
[PASS] GitHub org access verified (8gi-foundation/circle)
...
**Reviewed by:** 8GI Foundation (CAO)
