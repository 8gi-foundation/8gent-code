...
**Date:** 26 March 2026
**Vouched by:** 8GI Foundation (Founder, CAO)
...
8GI Foundation vouches for you.
...
- [ ] **3. Add ARTALE to 8gi-foundation GitHub org** - go to https://github.com/orgs/8gi-foundation/people and invite their GitHub account. Give them "Member" role (not admin). Confirm their GitHub account is not a throwaway - check account age and activity.
