...
3. Telegram notification:
   - Send to [REDACTED-BOT] with plain-language summary
...
- Telegram notification to [REDACTED-BOT] with summary
...
| **Telegram Bot** | [REDACTED-BOT] | Cloud | Notifications and approvals | Instant |
...
Telegram notification sent to [REDACTED-BOT]
```
