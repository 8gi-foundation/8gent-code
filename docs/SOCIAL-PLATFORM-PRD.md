...
### Files to modify
- `/home/operator/8gent-world/src/app/8gents/profiles/[code]/page.tsx` - add GitHub data
- Create `/home/operator/8gent-world/src/lib/github-api.ts` - GitHub data fetcher with caching
...
Location: `/home/operator/8gent-world/src/lib/agent-trust-scorer.ts`
