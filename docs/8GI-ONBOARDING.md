...
### Accounts
- **GitHub account.** You'll be added to the [8gi-foundation](https://github.com/8gi-foundation) org. This is where the codebases live.
...
**To confirm your agreement:** Message James directly on Telegram ([REDACTED]) with "I've read the Constitution and I'm in." That's it. No forms, no signatures, no ceremony.
...
### GitHub Organization
All code lives under the [8gi-foundation](https://github.com/8gi-foundation) GitHub org. You'll get contributor access to relevant repos.
...
- **Urgent issues:** DM James on Telegram ([REDACTED])
...
*Questions? Telegram group or DM [REDACTED]*
