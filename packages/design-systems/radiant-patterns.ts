...
export const COLOR_PATTERNS = {
	...
	corePalette: {
		...
		description:
			"Warm amber on near-black. The accent (#c8956c) is a golden-brown that reads as luxurious and creative. Text uses warm off-white (#e8e0d8) with rgba opacity layers for hierarchy.",
	},
	...
	opacityScale: {
		...
		description:
			"Radiant uses a precise 13-step opacity scale for text and borders. This creates visual depth without additional colors. Apply to rgba(232,224,216,X) for text and rgba(200,149,108,X) for accent.",
	},

	// -- Gradient patterns --
	gradients: {
		heroOverlayDesktop:
			"linear-gradient(to right, rgba(10, 10, 10, 0.55) 0%, rgba(10, 10, 10, 0.15) 45%, transparent 70%)",
		heroOverlayMobile:
			"linear-gradient(to bottom, rgba(10, 10, 10, 0.6) 0%, rgba(10, 10, 10, 0.25) 30%, transparent 55%)",
		...
		description:
			"Hero uses directional overlay gradients to create text-readable zones over shader backgrounds. Mobile switches to vertical gradient. Ambient glow uses layered radial gradients positioned at top edge for aurora-like effect.",
	},
} as const;
...
export const LAYOUT_PATTERNS = {
	...
	pageStructures: {
		homepage: {
			structure:
				"Hero (100dvh) -> Featured grid -> HowToUse (3-col steps) -> Changelog -> Pricing -> Footer",
		...
		shaderDetailLayout: {
			...
			fullHeight: "100vh",
			description:
				"Three-panel layout when source is open. Fills viewport height. Preview area flexes to fill remaining space.",
		},
	},
	...
	grids: {
		galleryGrid: {
			...
			mobilePadding: "1rem",
			description:
				"Auto-fill grid that adapts from 1 to 3+ columns. Min card width 380px ensures readability.",
		},
		featuredGrid: {
			...
			mobileColumns: "1fr",
			description:
				"Fixed 3-column grid for curated selections. Steps down to 2 at 900px, 1 at 640px.",
		},
		stepsGrid: {
			css: "grid-template-columns: repeat(3, 1fr)",
			gap: "2.5rem",
	...
	spacing: {
		...
		description:
			"Spacing uses rem units. Nav height is a CSS variable used throughout for offset calculations. Sections use generous vertical padding (4-5rem desktop, 3rem mobile).",
	},
	...
	aspectRatios: {
		...
		description:
			"Shader previews use 16:9 for cinematic feel. Card thumbnails use slightly taller 16:10. Inline hero shader uses 4:3.",
	},
} as const;
...
export const ANIMATION_PATTERNS = {
	...
	keyframes: {
      ...
      `,
			description:
				"Slow ambient breathing effect for background glow elements. Very subtle scale oscillation creates living, organic feel. 20s cycle prevents noticeable repetition.",
		},
		fadeUp: {
			name: "fadeUp",
			duration: "0.3s",
      ...
      `,
			description:
				"Floating controls entrance. Combines centered positioning with upward slide. Quick 300ms for responsive feel.",
		},
	},
	...
	motionPreferences: {
		...
		smoothScroll:
			"@media (prefers-reduced-motion: no-preference) { html:not(.restoring-scroll) { scroll-behavior: smooth; } }",
		shaderPause:
			'var prefersReduced = window.matchMedia("(prefers-reduced-motion: reduce)").matches;',
		description:
			"All shaders check prefers-reduced-motion on init. Smooth scroll respects user preference. Navigation back/forward temporarily disables smooth scroll for instant restoration.",
	},
	...
	shaderTechniques: {
		visibilityPause: {
			...
			description:
				"Shaders pause requestAnimationFrame when off-screen. 200px rootMargin prefetches before scrolling into view.",
		},
		iframePauseResume: {
			pause: "window.__shaderPause() - queues rAF callbacks",
			resume: "window.__shaderResume() - flushes queued callbacks",
			description:
				"Custom pause/resume injected into shader HTML via script tag in <head>. Patches window.requestAnimationFrame to queue/flush callbacks.",
		},
		dprAwareness: {
			implementation: "Canvas DPR capped at 2x",
			description:
				"All shaders account for device pixel ratio but cap at 2x to prevent GPU overload on 3x+ screens.",
		},
		postMessageParams: {
		...
		lerpSmoothing: {
			...
			description:
				"Hero drag-to-rotate uses linear interpolation at 6% per frame for buttery smooth camera movement.",
		},
	},
} as const;
...
export const COMPONENT_PATTERNS = {
	...
	hero: {
		...
		description:
			"Full-bleed shader hero with content overlaid via gradient mask. Controls bar uses glass-morphism (backdrop-filter: blur(12px), semi-transparent background, subtle amber border). Mobile collapses to centered text with bottom padding for controls.",
	},
	...
	card: {
		...
		description:
			"Cards use CSS custom property for per-card accent color (driven by inspiration artist palette). Preview area shows sprite sheet (6 color scheme frames stacked vertically). On hover, iframe loads and fades in over sprite. Card lifts 2px with border brightening. Number label uses monospace uppercase convention.",
	},
	...
	buttons: {
		...
		controlButton: {
			...
			fontSize: "0.65rem",
			activeState:
				"border-color: rgba(200,149,108,0.5), color: #c8956c, background: rgba(200,149,108,0.06)",
		},
		actionButton: {
		...
		description:
			"Two primary button types: solid (amber fill, dark text) and ghost (transparent, amber border). Control buttons are smaller, used in sidebars. Action buttons are compact for toolbar contexts. All use fast 200ms transitions.",
	},
	...
	sidebar: {
		...
		description:
			"Sticky sidebar with category navigation. Active state uses left accent border. Section headings are tiny uppercase amber labels. Counts are very muted. Custom thin scrollbar matches theme.",
	},
	...
	floatingControls: {
		...
		description:
			"Pill-shaped glass-morphism controls floating at bottom center. Used for both hero controls and gallery color scheme picker. Appears with upward fade animation when gallery scrolls into view.",
	},
	...
	sourceViewer: {
		...
		titleStyle:
			"font-size: 0.7rem, uppercase, letter-spacing: 0.12em, color: rgba(232,224,216,0.4)",
	...
	ambientGlow: {
		...
		description:
			"Creates aurora-like colored glow across top of inspiration gallery pages. Uses artist palette colors. Subtle breathing animation (opacity + scaleX) prevents static appearance.",
	},
	...
	footer: {
		...
		description:
			"Two-tier footer. Top tier: wordmark, links, social icons. Bottom tier: copyright and license. Very muted to not compete with content.",
	},
	...
	rangeSliders: {
		...
		labelStyle:
			"font-size: 0.65rem, uppercase, letter-spacing: 0.1em, color: rgba(200,149,108,0.5)",
		valueStyle:
			"font-size: 0.6rem, color: rgba(232,224,216,0.3), font-variant-numeric: tabular-nums",
		description:
			"Custom styled range inputs. Thin amber tracks with round amber thumbs that grow on hover. Labels are tiny uppercase. Values use tabular-nums for alignment.",
	},
	...
	interactionHint: {
		...
		description:
			"Monospace hint label floating over shader preview. Auto-detected based on shader interaction capabilities (click, drag, move). Glass-morphism style matching controls.",
	},
} as const;
...
export const TYPOGRAPHY_PATTERNS = {
	...
	fontStack: {
		...
		description:
			"Inter is the only custom font. Light weights (300) dominate headings for an airy, premium feel. Body uses 400. Bold elements use 500. Monospace used for code, labels, and shader titles.",
	},
	...
	typeScale: {
		...
		miniLabel: "0.55rem",
		description:
			"Hero uses fluid type via clamp(). Rest of the scale is static rem values. Hierarchy goes from 1.5rem section headings down to 0.55rem for hint text. Very few sizes above 1.5rem, keeping the overall feel restrained.",
	},
	...
	letterSpacing: {
		...
		description:
			"Letter-spacing is consistently applied to uppercase elements (wider) and brand elements (minimal). This creates the refined, editorial typography feel.",
	},
	...
	lineHeights: {
		...
		description:
			"Code and changelog use generous 1.7 line-height for scan-ability. Body paragraphs use 1.6. Headings compress to 1.1-1.2.",
	},
} as const;
...
export const VISUAL_EFFECTS = {
	...
	backdropBlur: {
		...
		description:
			"Glass morphism is the primary depth technique. Always include -webkit prefix. Combined with semi-transparent dark backgrounds (rgba(10,10,10,0.5-0.85)) and thin amber borders.",
	},
	...
	borders: {
		...
		description:
			"All borders use amber at very low opacity. This creates definition without harshness. Card borders use CSS custom property for per-card accent. Active states increase opacity.",
	},

	// -- CSS mask/clip --
	masks: {
		accentFade:
			"-webkit-mask-image: linear-gradient(to right, transparent 0%, black 40%); mask-image: linear-gradient(to right, transparent 0%, black 40%)",
		description:
			"Used in accent layout to fade shader from transparent to opaque, creating a dramatic side reveal effect. Always include -webkit prefix.",
	},
	...
	scrollbars: {
		...
		description:
			"Custom scrollbars matching amber theme. Very thin (4-6px). Both Webkit and Firefox syntaxes. Track is transparent, thumb is muted amber.",
	},
	...
	overlays: {
		...
		description:
			"Overlays ensure text readability over shaders. Desktop uses left-to-right gradient (content side darker). Mobile switches to top-down. Sidebar mobile overlay is simple semi-black.",
	},
	...
	colorFilters: {
		...
		description:
			"Color schemes are pure CSS filter chains applied to shader iframes. No shader modification needed. This technique works with any visual content and allows runtime switching.",
	},
...
export const RESPONSIVE_PATTERNS = {
	breakpoints: {
		...
		wide: "1200px",
		description:
			"Three primary breakpoints: 640px (mobile), 768px (tablet/sidebar collapse), 900px (grid column reduction). Content max-widths: 600px (hero content), 800px (support), 900px (how-to-use, changelog).",
	},
	...
	adaptivePatterns: {
		...
		description:
			"Key adaptive patterns: fluid type for hero, CSS variables for computed offsets, sprite sheets for instant color scheme previews without re-rendering, scroll restoration handling.",
	},
} as const;
...
export const SHADER_CATALOG: ShaderEntry[] = [
	...
	},
	{
		...
		description: "Golden angle spiral with Fibonacci lattice connections.",
		tags: ["object", "geometric", "organic"],
		technique: "canvas-2d",
		parameterNames: ["MAX_POINTS", "SPREAD"],
	},
	{
		id: "fluid-amber",
		title: "Fluid Amber",
	...
	},
	{
		...
		description:
			"Effervescent bubbles rising with wobble physics, refractive highlights, and sparkle bursts.",
		tags: ["fill", "particles", "physics"],
		technique: "canvas-2d",
		inspiration: "Sabrina Carpenter",
		parameterNames: ["BUBBLE_RATE", "RISE_SPEED"],
	},
	{
		id: "sugar-glass",
		title: "Sugar Glass",
		description:
			"Caramelized sugar glass with Voronoi fracture patterns and golden light bleeding through cracks.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Sabrina Carpenter",
		parameterNames: ["CRACK_SPEED", "LIGHT_BLEED"],
	},
	{
		id: "resonant-strings",
		title: "Resonant Strings",
		description:
			"Vibrating cello strings with standing wave harmonics, overtone interference, and rosin dust particles.",
		tags: ["object", "physics"],
		technique: "canvas-2d",
		inspiration: "Laufey",
		parameterNames: ["HARMONIC_COUNT", "VIBRATION_SPEED"],
	},
	{
		id: "chladni-resonance",
		title: "Chladni Resonance",
		description:
			"Sand patterns forming on a vibrating plate, morphing between harmonic modes with golden glow.",
		tags: ["object", "geometric", "physics"],
		technique: "webgl",
		inspiration: "Laufey",
		parameterNames: ["MODE_SPEED", "COMPLEXITY"],
	},
	{
		id: "kinetic-grid",
		title: "Kinetic Grid",
		description:
			"Spring-connected grid mesh with traveling force impulses, tension-colored connections in cyan and magenta.",
		tags: ["fill", "physics"],
		technique: "canvas-2d",
	...
	},
	{
		...
		description:
			"Sharp neon geometric shapes flashing in choreographed sequence with cyan-to-magenta afterglow decay.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Dua Lipa",
		parameterNames: ["FLASH_RATE", "GLOW_INTENSITY"],
	},
	{
		id: "laser-labyrinth",
		title: "Laser Labyrinth",
		description:
			"Volumetric laser beams crossing in a dark void with prismatic colors and intersection flares.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Dua Lipa",
		parameterNames: ["SWEEP_SPEED", "BEAM_INTENSITY"],
	},
	{
		id: "bass-ripple",
		title: "Bass Ripple",
		description:
			"Vibrating speaker mesh with beat-synced wave displacement and metallic specular sheen.",
		tags: ["fill", "physics"],
		technique: "webgl",
		inspiration: "Dua Lipa",
		parameterNames: ["BASS_FREQ", "BASS_INTENSITY"],
	},
	{
		id: "ink-dissolve",
		title: "Ink Dissolve",
		description:
			"Dense ink tendrils spreading through amber liquid with reaction-diffusion branching patterns.",
		tags: ["fill", "noise", "organic"],
		technique: "webgl",
		inspiration: "Billie Eilish",
		parameterNames: ["SPREAD_SPEED", "TENDRIL_DETAIL"],
	},
	{
		id: "sequin-wave",
		title: "Sequin Wave",
		description:
			"Grid of metallic sequin discs catching sweeping light with specular reflections and warm shimmer.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Taylor Swift",
		parameterNames: ["WAVE_SPEED", "SPARKLE_INTENSITY"],
	},
	{
		id: "gilt-mosaic",
		title: "Gilt Mosaic",
		description:
			"Byzantine golden mosaic wall with individually shimmering tiles catching candlelight.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Beyonce",
		parameterNames: [
	...
	},
	{
		...
		description:
			"Kintsugi-inspired golden cracks spreading across dark surface with molten gold light bleeding through.",
		tags: ["fill", "noise", "organic"],
		technique: "webgl",
		inspiration: "Beyonce",
		parameterNames: ["CRACK_SPEED", "GLOW_INTENSITY"],
	},
	{
		id: "radiant-geometry",
		title: "Radiant Geometry",
		description:
			"Animated Islamic geometric art with layered golden star patterns and counter-rotating tracery.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Beyonce",
		parameterNames: ["ROTATION_SPEED", "PATTERN_COMPLEXITY"],
	},
	{
		id: "golden-throne",
		title: "Golden Throne",
		...
		technique: "webgl",
		inspiration: "Beyonce",
		parameterNames: ["ROTATION_SPEED", "COMPLEXITY"],
	},
	{
		id: "sacred-strange",
		title: "Sacred Strange",
		description:
			"Fractal golden geometry with overlapping star motifs creating Doctor Strange-like dimensional patterns.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Benedict Cumberbatch",
		parameterNames: ["ROTATION_SPEED", "PATTERN_COMPLEXITY", "PATTERN"],
	},
	{
		id: "tropical-heat",
		title: "Tropical Heat",
		...
		parameterNames: ["HEAT_INTENSITY", "COLOR_VIBRANCY"],
	},
	{
		id: "neon-drip",
		title: "Neon Drip",
		description:
			"Metaball blobs dripping upward with surface tension physics and trailing tendrils.",
		tags: ["fill", "organic"],
		technique: "webgl",
		inspiration: "Bad Bunny",
		parameterNames: ["DRIP_SPEED", "BLOB_COUNT"],
	},
	{
		id: "voltage-arc",
		title: "Voltage Arc",
		...
		technique: "webgl",
		inspiration: "Bad Bunny",
		parameterNames: ["ARC_INTENSITY", "CRACKLE_SPEED"],
	},
	{
		id: "moonlit-ripple",
		title: "Moonlit Ripple",
		description:
			"Moon reflection on dark water with multi-directional waves, Fresnel reflection, and 3D perspective.",
		tags: ["fill", "noise"],
		technique: "webgl",
		inspiration: "SZA",
		defaultScheme: "blue",
	...
	},
	{
		...
		title: "Eclipse Glow",
		description:
			"Solar eclipse corona with radial noise rays, diamond ring effect, and streaming solar wind.",
		tags: ["object", "noise"],
		technique: "webgl",
		inspiration: "SZA",
		parameterNames: ["CORONA_SIZE", "RAY_INTENSITY"],
	},
	{
		id: "diamond-caustics",
		title: "Diamond Caustics",
		description:
			"Light refracting through rotating diamond facets casting prismatic caustic patterns.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Rihanna",
		parameterNames: ["ROTATION_SPEED", "BRILLIANCE"],
	},
	{
		id: "rain-on-glass",
		title: "Rain on Glass",
		description:
			"Ultra-realistic water droplets on a window, refracting a blurred city night with realistic trail physics.",
		tags: ["fill", "physics", "noise"],
		technique: "webgl",
		inspiration: "Rihanna",
		parameterNames: ["RAIN_AMOUNT", "REFRACTION"],
	},
	{
		id: "rain-umbrella",
		title: "Rain on Umbrella",
		description:
			"Looking up through a translucent umbrella at city lights, with refractive drops sliding down the dome.",
		tags: ["fill", "physics", "noise"],
		technique: "webgl",
		inspiration: "Rihanna",
		parameterNames: ["RAIN_AMOUNT", "REFRACTION", "WALK_SPEED"],
	},
	{
		id: "metamorphosis",
		title: "Metamorphosis",
		description:
			"Raymarched metaballs continuously merging and splitting with liquid-metal surface.",
		tags: ["object", "organic"],
		technique: "webgl",
		inspiration: "Lady Gaga",
		parameterNames: ["MORPH_SPEED", "BLOB_COUNT"],
	},
	{
		id: "artpop-iridescence",
		title: "Artpop Iridescence",
		description:
			"Holographic membrane with thin-film interference creating prismatic color shifts across an undulating surface.",
		tags: ["fill", "organic", "noise"],
		technique: "webgl",
		inspiration: "Lady Gaga",
		hasHeroConfig: true,
		parameterNames: ["FILM_THICKNESS", "FLOW_SPEED"],
	},
	{
		id: "silk-groove",
		title: "Silk Groove",
		...
		parameterNames: ["FLOW_SPEED", "WAVE_AMPLITUDE"],
	},
	{
		id: "gilt-thread",
		title: "Gilt Thread",
		description:
			"Golden threads tracing intricate parametric curves with metallic sheen and sparkle tips.",
		tags: ["object", "geometric"],
		technique: "webgl",
		inspiration: "Bruno Mars",
		parameterNames: ["SHAPE", "DRAW_SPEED", "THREAD_COUNT"],
	},
	{
		id: "event-horizon",
		title: "Event Horizon",
		description:
			"Physics-based black hole with raytraced gravitational lensing, volumetric accretion disk, and Doppler beaming.",
		tags: ["object", "physics"],
		technique: "webgl",
	...
	},
	{
		...
		title: "Burning Film",
		description:
			"Celluloid film stock catching fire with spreading amber burn holes, glowing edges, and ember field.",
		tags: ["fill", "noise"],
		technique: "webgl",
		inspiration: "The Weeknd",
		parameterNames: ["BURN_SPEED", "EMBER_GLOW"],
	},
	{
		id: "vertigo",
		title: "Vertigo",
		description:
			"Slow hypnotic tunnel with crimson ring segments, wave-based illumination, and dark void center.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "The Weeknd",
		parameterNames: ["TUNNEL_SPEED", "SPIRAL_INTENSITY"],
	},
	{
		id: "stardust-veil",
		title: "Stardust Veil",
		description:
			"Dense cosmic stardust with parallax depth layers, aurora ribbons, constellation threads, and brightness waves.",
		tags: ["fill", "particles", "noise"],
		technique: "webgl",
		inspiration: "Ariana Grande",
		parameterNames: ["DRIFT_SPEED", "STAR_DENSITY"],
	},
	{
		id: "silk-cascade",
		title: "Silk Cascade",
		description:
			"Flowing layered silk fabric with anisotropic specular highlights, parallax depth, and warm translucent overlap.",
		tags: ["fill", "organic", "noise"],
		technique: "webgl",
		inspiration: "Ariana Grande",
		parameterNames: ["FLOW_SPEED", "SHEEN_INTENSITY"],
	},
	{
		id: "smolder",
		title: "Smolder",
		description:
			"Radial warmth radiating through animated turbulence with heat shimmer, ember particles, and cool blue edges.",
		tags: ["fill", "noise"],
		technique: "webgl",
		inspiration: "Pedro Pascal",
		hasHeroConfig: true,
		parameterNames: ["HEAT_INTENSITY", "TURBULENCE"],
	},
	{
		id: "signal-decay",
		title: "Signal Decay",
		description:
			"Clean amber waveforms progressively degrading into gorgeous warm noise - order dissolving into beautiful chaos.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Billie Eilish",
		parameterNames: ["SIGNAL_SPEED", "DECAY_INTENSITY"],
	},
	{
		id: "neon-revival",
		title: "Neon Revival",
		description:
			"Flickering neon sign with electrical buzz, dripping light particles, and wall reflections.",
		tags: ["object", "particles"],
		technique: "webgl",
		inspiration: "Chappell Roan",
		hasHeroConfig: true,
		parameterNames: ["SHAPE", "FLICKER_RATE", "GLOW_SPREAD"],
	},
	{
		id: "lipstick-smear",
		title: "Lipstick Smear",
		description:
			"Viscous fluid simulation in hot pink and crimson - bold pigment streaking and blending with metallic sheen.",
		tags: ["fill", "physics", "organic"],
		technique: "webgl",
		inspiration: "Chappell Roan",
		parameterNames: ["VISCOSITY", "COLOR_INTENSITY"],
	},
	{
		id: "glitter-storm",
		title: "Glitter Storm",
		description:
			"Dense field of tumbling metallic glitter flakes catching rotating spotlights with specular flash physics.",
		tags: ["fill", "particles", "physics"],
		technique: "canvas-2d",
		inspiration: "Chappell Roan",
		parameterNames: ["SPARKLE_RATE", "DENSITY"],
	},
	{
		id: "rubber-reality",
		title: "Rubber Reality",
		description:
			"Elastic grid mesh deformed by traveling attractors with spring physics and snap-back.",
		tags: ["fill", "physics", "geometric"],
		technique: "canvas-2d",
		inspiration: "Jim Carrey",
		parameterNames: ["ELASTICITY", "DISTORTION_POINTS"],
	},
	{
		id: "magma-core",
		title: "Magma Core",
		...
		parameterNames: ["ERUPTION_FORCE", "ERUPTION_INTERVAL"],
	},
	{
		id: "clockwork-mind",
		title: "Clockwork Mind",
		description:
			"Interlocking precision gears with metallic rendering and mathematically correct meshing.",
		tags: ["object", "geometric"],
		technique: "canvas-2d",
		inspiration: "Robert Downey Jr.",
		hasHeroConfig: true,
		parameterNames: ["ROTATION_SPEED", "GEAR_DETAIL"],
	},
	{
		id: "edge-of-chaos",
		title: "Edge of Chaos",
		...
		technique: "webgl",
		inspiration: "Robert Downey Jr.",
		parameterNames: ["PATTERN_SPEED", "POP_RATE"],
	},
	{
		id: "spark-chamber",
		title: "Spark Chamber",
		description:
			"Charged particles spiraling through a magnetic field, leaving curved trails like cloud chamber photography.",
		tags: ["fill", "particles", "physics"],
		technique: "canvas-2d",
		inspiration: "Robert Downey Jr.",
		parameterNames: ["EMISSION_RATE", "FIELD_STRENGTH"],
	},
	{
		id: "shifting-veils",
		...
		parameterNames: ["LAYER_SPEED", "LAYER_COUNT"],
	},
	{
		id: "crystal-lattice",
		title: "Crystal Lattice",
		description:
			"Procedural crystal formations growing with faceted 3D lighting and prismatic sparkle.",
		tags: ["object", "geometric"],
		technique: "webgl",
		inspiration: "Anne Hathaway",
		hasHeroConfig: true,
		parameterNames: ["GROWTH_SPEED", "REFRACTION", "TILT_X", "TILT_Y"],
	},
	{
		...
		technique: "webgl",
		inspiration: "Zendaya",
		parameterNames: ["SYMMETRY", "PATTERN_SPEED"],
	},
	{
		id: "digital-rain",
		title: "Digital Rain",
		...
		parameterNames: ["FALL_SPEED", "COLUMN_DENSITY"],
	},
	{
		id: "desert-mirage",
		title: "Desert Mirage",
		...
		technique: "canvas-2d",
		inspiration: "Pedro Pascal",
		parameterNames: ["WIND_SPEED", "SHIMMER_INTENSITY"],
	},
	{
		id: "neon-drive",
		title: "Neon Drive",
		description:
			"Rain-slicked neon road stretching to a vanishing point with approaching headlights.",
		tags: ["fill", "particles"],
		technique: "webgl",
		inspiration: "Ryan Gosling",
		parameterNames: ["DRIVE_SPEED", "RAIN_INTENSITY"],
	},
	{
		id: "liquid-gold",
		title: "Liquid Gold",
		description:
			"Molten metal flow with surface tension, metallic PBR shading, and golden reflections.",
		tags: ["fill", "noise", "organic"],
		technique: "webgl",
		inspiration: "Margot Robbie",
		parameterNames: ["FLOW_SPEED", "VISCOSITY"],
	},
	{
		id: "aurora-veil",
		title: "Aurora Veil",
		...
		parameterNames: ["AURORA_SPEED", "AURORA_INTENSITY"],
	},
	{
		id: "bioluminescence",
		...
		inspiration: "Zendaya",
		defaultScheme: "blue",
		parameterNames: ["GLOW_INTENSITY", "WAVE_SPEED"],
	},
	{
		id: "gothic-filigree",
		title: "Gothic Filigree",
		description:
			"Ornate fractal lace scrollwork growing from corners with dark metallic rendering.",
		tags: ["fill", "organic", "geometric"],
		technique: "webgl",
		inspiration: "Jenna Ortega",
		parameterNames: ["GROWTH_SPEED", "CURL_TIGHTNESS"],
	},
	{
		id: "laser-precision",
		title: "Laser Precision",
		description:
			"Laser beams tracing geometric patterns with spark particles and intersection flares.",
		tags: ["fill", "geometric"],
		technique: "canvas-2d",
		inspiration: "Ana de Armas",
		hasHeroConfig: true,
		parameterNames: ["DRAW_SPEED", "LINE_BRIGHTNESS", "SHAPE"],
	},
	{
		id: "magnetic-sand",
		title: "Magnetic Sand",
		description:
			"Thousands of particles aligning along invisible magnetic field lines with warm golden glow.",
		tags: ["fill", "particles", "physics"],
		technique: "canvas-2d",
		inspiration: "Ana de Armas",
		parameterNames: ["FIELD_STRENGTH", "PARTICLE_COUNT"],
	},
	{
		id: "woven-radiance",
		...
		parameterNames: ["WEAVE_SPEED", "COLOR_RICHNESS"],
	},
	{
		id: "jazz-chaos",
		title: "Jazz Chaos",
	...
	},
	{
		...
		technique: "webgl",
		inspiration: "The Weeknd",
		parameterNames: ["STRIKE_INTERVAL", "BRANCH_COMPLEXITY"],
	},
	{
		id: "vinyl-grooves",
		title: "Vinyl Grooves",
		...
		technique: "webgl",
		inspiration: "Laufey",
		parameterNames: ["RPM", "GROOVE_DETAIL"],
	},
	{
		id: "vintage-static",
		...
		parameterNames: ["GLITCH_INTENSITY", "MELT_SPEED"],
	},
	{
		id: "torn-paper",
		title: "Torn Paper",
		description:
			"Paper surface tearing apart with fibrous edges revealing warm volumetric light underneath, then reforming.",
		tags: ["fill", "noise", "organic"],
		technique: "webgl",
		inspiration: "Olivia Rodrigo",
		parameterNames: ["TEAR_SPEED", "GLOW_INTENSITY"],
	},
	{
		id: "polaroid-burn",
		title: "Polaroid Burn",
		description:
			"Scattered polaroid photos developing warm abstract memories, overexposing, and burning out with ember edges.",
		tags: ["fill", "noise"],
		technique: "webgl",
		inspiration: "Olivia Rodrigo",
		parameterNames: ["BURN_SPEED", "PHOTO_COUNT"],
	},
	{
		id: "scream-wave",
		title: "Scream Wave",
		description:
			"Glowing waveform building from gentle sine to distorted scream with chromatic aberration and collapse.",
		tags: ["object", "physics"],
		technique: "webgl",
		inspiration: "Olivia Rodrigo",
		parameterNames: ["INTENSITY", "WAVE_SPEED"],
	},
	{
		id: "ink-calligraphy",
		title: "Ink Calligraphy",
		description:
			"Abstract gestural ink strokes with organic diffusion on textured paper and luminous gold leaf highlights.",
		tags: ["fill", "organic"],
		technique: "canvas-2d",
		inspiration: "Anne Hathaway",
		parameterNames: ["STROKE_SPEED", "INK_DENSITY", "GOLD_AMOUNT", "PALETTE"],
	},
	{
		id: "velvet-spotlight",
		title: "Velvet Spotlight",
		description:
			"Theatrical dust particles caught in sweeping spotlight cones with volumetric rays and warm scattering haze.",
		tags: ["fill", "particles"],
		technique: "canvas-2d",
		inspiration: "Anne Hathaway",
		parameterNames: ["DUST_DENSITY", "SWEEP_SPEED"],
	},
	{
		id: "murmuration",
		title: "Murmuration",
		description:
			"Thousands of flocking particles forming flowing ribbons with emergent density waves against a warm twilight sky.",
		tags: ["fill", "particles", "physics"],
		technique: "canvas-2d",
		inspiration: "Anne Hathaway",
		parameterNames: ["FLOCK_SIZE", "COHESION", "PALETTE"],
	},
	{
		id: "tesseract-shadow",
		title: "Tesseract Shadow",
		description:
			"4D hypercube projected into 2D with depth-faded wireframe, axis-mapped colors, and rotation trails.",
		tags: ["object", "geometric"],
		technique: "canvas-2d",
		inspiration: "Benedict Cumberbatch",
		hasHeroConfig: true,
		parameterNames: ["ROTATION_SPEED", "PROJECTION_DEPTH"],
	},
	{
		id: "moire-interference",
		title: "Moire Interference",
		description:
			"Overlapping concentric ring patterns creating hypnotic emergent moire interference.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Benedict Cumberbatch",
		parameterNames: ["RING_DENSITY", "DRIFT_SPEED"],
	},
	{
		id: "phase-transition",
		title: "Phase Transition",
		description:
			"Particles oscillating between crystalline lattice order and chaotic turbulence with a traveling phase wavefront.",
		tags: ["fill", "particles", "physics"],
		technique: "canvas-2d",
		inspiration: "Benedict Cumberbatch",
		parameterNames: ["WAVE_SPEED", "PARTICLE_DENSITY"],
	},
	{
		id: "magnetic-field",
		title: "Magnetic Field",
		description:
			"Dipole field lines curving between slowly rotating poles with silk-thread glow rendering.",
		tags: ["fill", "geometric", "physics"],
		technique: "webgl",
		inspiration: "Cate Blanchett",
		parameterNames: ["WAVE_SPEED", "LINE_COUNT"],
	},
	{
		id: "aurora-curtain",
		title: "Aurora Curtain",
		description:
			"Vertical luminous threads swaying like aurora borealis curtains with warm-to-cool color gradient.",
		tags: ["fill", "organic"],
		technique: "webgl",
		inspiration: "Meryl Streep",
		parameterNames: ["WAVE_SPEED", "LINE_COUNT", "AMPLITUDE", "ROTATION"],
	},
	{
		id: "vortex",
		title: "Vortex",
		description:
			"Logarithmic spiral arms converging on a drifting center with silk-thread glow and undulating perturbation.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Lupita Nyong'o",
		parameterNames: ["WAVE_SPEED", "LINE_COUNT"],
	},
	{
		...
		description:
			"Luminous color orbs drifting on pure black with Gaussian glow, additive blending, film grain, and cinematic vignette.",
		tags: ["fill", "noise"],
		technique: "webgl",
		inspiration: "Lady Gaga",
		parameterNames: ["DRIFT_SPEED", "GRAIN_AMOUNT"],
	},
	{
		id: "lens-whisper",
		title: "Lens Whisper",
		description:
			"Anamorphic lens flares with chromatic color separation, horizontal streaks, bokeh halos, and cinematic film grain.",
		tags: ["fill", "noise"],
		technique: "webgl",
		inspiration: "Ryan Gosling",
		parameterNames: ["FLARE_SPREAD", "DRIFT_SPEED"],
	},
	{
		id: "luminous-silt",
		title: "Luminous Silt",
		description:
			"Dense field of 18K particles creating soft color clouds through alpha accumulation over a noise-driven flow field.",
		tags: ["fill", "particles", "noise"],
		technique: "canvas-2d",
		inspiration: "Lupita Nyong'o",
		parameterNames: ["DRIFT_SPEED", "DENSITY"],
	},
	{
		id: "synth-ribbon",
		title: "Synth Ribbon",
		description:
			"Flowing metallic ribbons twisting through 3D space with chrome reflections in hot pink and cyan.",
		tags: ["fill", "geometric"],
		technique: "canvas-2d",
		inspiration: "Chappell Roan",
		parameterNames: ["RIBBON_COUNT", "TWIST_SPEED"],
	},
	{
		id: "hologram-glitch",
		title: "Hologram Glitch",
		description:
			"Abstract holographic texture with chromatic aberration, scanlines, and controlled glitch bursts.",
		tags: ["fill", "noise"],
		technique: "webgl",
		inspiration: "Daft Punk",
		parameterNames: ["GLITCH_INTENSITY", "SCAN_SPEED"],
	},
	{
		id: "shattered-plains",
		title: "Shattered Plains",
		description:
			"Storm-carved chasms branching through ancient sandstone plateaus with depth-revealed strata.",
		tags: ["fill", "noise", "organic"],
		technique: "webgl",
		inspiration: "Brandon Sanderson",
		parameterNames: ["CHANNEL_SPEED", "CHANNEL_DEPTH", "GRAIN"],
	},
	{
		id: "painted-strata",
		title: "Painted Strata",
		description:
			"Flowing layered bands with washi paper textures, slow tectonic folding, and fibrous grain.",
		tags: ["fill", "noise", "organic"],
		technique: "webgl",
		inspiration: "Laufey",
		parameterNames: ["FOLD_SPEED", "LAYER_COUNT"],
	},
	{
		id: "feedback-loop",
		title: "Feedback Loop",
		description:
			"Recursive video feedback tunnel with holographic color cycling, geometric seed shapes, and infinite fractal depth.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Daft Punk",
		parameterNames: ["ZOOM_SPEED", "ROTATION_SPEED"],
	},
	{
		id: "dither-gradient",
		title: "Dither Gradient",
		description:
			"Smooth gradients decomposed into shifting ordered dithering patterns with chromatic separation and bit-depth waves.",
		tags: ["fill", "geometric"],
		technique: "webgl",
		inspiration: "Daft Punk",
		parameterNames: ["DITHER_SCALE", "BIT_DEPTH"],
	},
	{
		id: "analog-drift",
		title: "Analog Drift",
		description:
			"Morphing Lissajous figures with phosphor persistence trails, harmonic overtones, and oscilloscope grid.",
		tags: ["object", "geometric"],
		technique: "canvas-2d",
		inspiration: "Daft Punk",
		parameterNames: ["DRIFT_SPEED", "TRAIL_LENGTH"],
	},
];
...
export const LAYOUT_TEMPLATES = {
	...
	backgroundOverlay: {
		description:
			"Full-viewport shader with dark overlay (rgba(10,10,10,0.7)) and centered content. Good for call-to-action screens.",
		overlay:
			"position: absolute, inset: 0, flex column, center content, background: rgba(10,10,10,0.7)",
		headingSize: "3rem",
		ctaStyle: "padding: 0.75rem 2rem, amber solid, rounded 6px",
	},
	accentSplit: {
		description:
			"Content left (max-width: 40%), shader right with CSS mask fade. Shader positioned at left: 50%, masked with gradient from transparent to opaque.",
