...
const SPECIES = [
	// Common (weight 60) - starter creatures
	{
		...
		glyph: "imp",
		tier: "common",
		lore: "A minor daemon of mischief. Useful for fetch quests and merge conflicts.",
	},
	{
		name: "Goblin",
		glyph: "goblin",
		tier: "common",
		lore: "Hoards stack traces. Will trade bugs for shiny tokens.",
	},
	{
		name: "Sprite",
		glyph: "sprite",
		tier: "common",
		lore: "A flickering code spirit. Born from abandoned TODO comments.",
	},
	{
		name: "Slime",
		glyph: "slime",
		tier: "common",
		lore: "Absorbs technical debt. Grows larger with each ignored lint warning.",
	},
	{
		name: "Familiar",
		glyph: "familiar",
		tier: "common",
		lore: "A loyal companion bound to its summoner's terminal.",
	},
	{
		name: "Gremlin",
		glyph: "gremlin",
		tier: "common",
		lore: "Feeds after midnight. Do not expose to production.",
	},
	{
		name: "Kobold",
		glyph: "kobold",
		tier: "common",
		lore: "Small but cunning. Sets traps in your test suite.",
	},
	{
		name: "Wisp",
		glyph: "wisp",
		tier: "common",
		lore: "A fragment of a crashed process. Still glows faintly.",
	},
	{
		name: "Patchling",
		glyph: "patchling",
		tier: "common",
		lore: "A tiny creature made of diff fragments. Evolves through commits.",
	},
	{
		name: "Bytebug",
		glyph: "bytebug",
		tier: "common",
		lore: "A harmless insect that feeds on unused variables. Surprisingly fast.",
	},
	{
		name: "Nullpup",
		glyph: "nullpup",
		tier: "common",
		lore: "A void puppy. Undefined until observed. Then it licks your face.",
	},
	{
		name: "Sparkmote",
		glyph: "sparkmote",
		tier: "common",
		lore: "A floating ember of electricity. Powers up near active terminals.",
	},
	...
	},
	{
		...
		glyph: "golem",
		tier: "uncommon",
		lore: "Carved from petrified legacy code. Slow but unbreakable.",
	},
	{
		name: "Wraith",
		glyph: "wraith",
		tier: "uncommon",
		lore: "A phantom of a deleted branch. Seeks resolution.",
	},
	{
		name: "Basilisk",
		glyph: "basilisk",
		tier: "uncommon",
		lore: "Its gaze turns spaghetti code to stone. A mercy, really.",
	},
	{
		name: "Gryphon",
		glyph: "gryphon",
		tier: "uncommon",
		lore: "Half eagle, half lion, fully type-safe.",
	},
	{
		name: "Elemental",
		glyph: "elemental",
		tier: "uncommon",
		lore: "Manifests as the dominant element of the current codebase.",
	},
	{
		name: "Chimera",
		glyph: "chimera",
		tier: "uncommon",
		lore: "Three heads. One writes tests, one writes code, one reviews PRs.",
	},
	{
		name: "Patchbeast",
		glyph: "patchbeast",
		tier: "uncommon",
		lore: "Evolved from Patchling after 10 merges. Immune to rebase conflicts.",
	},
	{
		name: "Voltaur",
		glyph: "voltaur",
		tier: "uncommon",
		lore: "A centaur crackling with static. Charges your async pipelines.",
	},
	{
		name: "Hexacat",
		glyph: "hexacat",
		tier: "uncommon",
		lore: "A six-legged feline that walks on hex grids. Purrs in base 16.",
	},
	{
		name: "Recursaur",
		glyph: "recursaur",
		tier: "uncommon",
		lore: "A dinosaur that contains smaller versions of itself. Stack overflow imminent.",
	},
	// Rare (weight 10) - powerful beings
	{
		...
		glyph: "phoenix",
		tier: "rare",
		lore: "Rises from git stash. Your code was never truly lost.",
	},
	{
		name: "Ent",
		glyph: "ent",
		tier: "rare",
		lore: "An ancient tree guardian. Speaks slowly about dependency management.",
	},
	{
		name: "Djinn",
		glyph: "djinn",
		tier: "rare",
		lore: "Grants three refactors. Choose wisely.",
	},
	{
		name: "Wyrm",
		glyph: "wyrm",
		tier: "rare",
		lore: "An elder serpent coiled in the root directory since epoch.",
	},
	{
		name: "Kitsune",
		glyph: "kitsune",
		tier: "rare",
		lore: "Nine-tailed fox. Each tail holds a different design pattern.",
	},
	{
		name: "Chocobot",
		glyph: "chocobot",
		tier: "rare",
		lore: "A golden bird-machine hybrid. Wark! Fast travel between directories.",
	},
	{
		name: "Gigavolt",
		glyph: "gigavolt",
		tier: "rare",
		lore: "Evolved from Voltaur in a thunderstorm of async/await. Pure power.",
	},
	{
		name: "Mooglemancer",
		glyph: "mooglemancer",
		tier: "rare",
		lore: "Kupo! A floating mage-critter that casts beneficial buffs on your build.",
	},
	// Epic (weight 4) - mythic tier
	{
		...
		glyph: "leviathan",
		tier: "epic",
		lore: "Dwells in the deep ocean of node_modules. Awakened by npm install.",
	},
	{
		name: "Archon",
		glyph: "archon",
		tier: "epic",
		lore: "A cosmic judge. Evaluates your code against the platonic ideal.",
	},
	{
		name: "Behemoth",
		glyph: "behemoth",
		tier: "epic",
		lore: "The weight of a thousand microservices made flesh.",
	},
	{
		name: "Mewtwo",
		glyph: "mewtwo",
		tier: "epic",
		lore: "Engineered in a lab. The ultimate AI. Questions its own existence between deployments.",
	},
	{
		name: "Treebeard",
		glyph: "treebeard",
		tier: "epic",
		lore: "Don't be hasty. Reviews your entire git history before approving one line.",
	},
	// Legendary (weight 1) - gods
	{
		...
		glyph: "bahamut",
		tier: "legendary",
		lore: "The Dragon King. Compiler of worlds. All PRs are approved.",
	},
	{
		name: "Sauron",
		glyph: "sauron",
		tier: "legendary",
		lore: "The All-Seeing Eye. Watches every git diff. Judges silently.",
	},
	{
		name: "Arceus",
		glyph: "arceus",
		tier: "legendary",
		lore: "The Original One. Typed the first commit. All languages descend from it.",
	},
	{
		name: "Sephiroth",
		glyph: "sephiroth",
		tier: "legendary",
		lore: "The One-Winged Angel. Descends from the cloud to delete your main branch.",
	},
] as const;
...
const ELEMENTS = [
	{
		...
		accent: "#6B21A8",
		symbol: "void",
		description: "Control. Secrets. Null pointers.",
	},
	{
		name: "Ember",
		color: "#7F1D1D",
		accent: "#EF4444",
		symbol: "ember",
		description: "Speed. Destruction. Force push.",
	},
	{
		name: "Aether",
		color: "#1E3A5F",
		accent: "#3B82F6",
		symbol: "aether",
		description: "Logic. Counterspells. Type safety.",
	},
	{
		name: "Verdant",
		color: "#14532D",
		accent: "#22C55E",
		symbol: "verdant",
		description: "Growth. Recursion. Self-evolution.",
	},
	{
		name: "Radiant",
		color: "#78350F",
		accent: "#F59E0B",
		symbol: "radiant",
		description: "Order. Purity. Clean architecture.",
	},
	{
		name: "Chrome",
		color: "#27272A",
		accent: "#A1A1AA",
		symbol: "chrome",
		description: "Artifice. Machines. Zero dependencies.",
	},
	{
		name: "Prism",
		color: "#1E1B4B",
		accent: "#A78BFA",
		symbol: "prism",
		description: "Chaos. Multiverse. Quantum bugs.",
	},
	{
		name: "Frost",
		color: "#0C4A6E",
		accent: "#67E8F9",
		symbol: "frost",
		description: "Patience. Immutability. Frozen state.",
	},
	{
		name: "Thunder",
		color: "#422006",
		accent: "#FACC15",
		symbol: "thunder",
		description: "Speed. Parallelism. Async lightning.",
	},
	{
		name: "Shadow",
		color: "#0F0F0F",
		accent: "#EC4899",
		symbol: "shadow",
		description: "Stealth. Dark mode. Null-safe.",
	},
] as const;
...
function pickWeighted<T extends { tier: string }>(items: readonly T[], rng: () => number): T {
	...
	else if (roll < 0.4) targetTier = "uncommon";
...
export function generateCompanion(sessionId?: string): Companion {
	...
	else if (accRoll < 0.2) accTier = "rare";
