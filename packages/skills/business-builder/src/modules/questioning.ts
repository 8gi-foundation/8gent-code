...
export class QuestioningEngine {
	...
	analyzeImplications(answer: string): {
		...
		const templates = [
			{
				...
				bodyContent:
					"The market is ripe for disruption. Customers are frustrated with current options, and your solution offers a compelling alternative...",
			...
			},
			{
				...
				bodyContent:
					"You don't have to struggle with [problem]. We built something specifically for people like you...",
			...
			},
			{
				...
				bodyContent:
					"Join our beta community and shape the future of [solution category] right now...",
