...
const CAPABILITY_TO_STREAM: Array<{
	...
	{
		keywords: ["bounty", "hacktoberfest", "reward", "paid issue"],
		type: "bounty",
		source: "GitHub Bounties",
	},
	{
		keywords: ["freelance", "contract", "hire", "upwork", "toptal"],
		type: "freelance",
		source: "Freelance Platforms",
	},
	{
		keywords: ["api", "saas", "subscription", "plugin", "extension"],
		type: "saas",
		source: "SaaS Products",
	},
	{
		keywords: ["docs", "tutorial", "blog", "writeup", "guide"],
		type: "content",
		source: "Content Creation",
	},
	{
		keywords: ["consult", "audit", "review", "advise", "assess"],
		type: "consulting",
		source: "Consulting",
	},
];
