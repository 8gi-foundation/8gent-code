...
export const BUSINESS_AGENTS: readonly AgentDef[] = [
	{
		...
		promptFocus:
			"business model, competitive landscape, market sizing, revenue streams, and growth vectors",
	},
	{
		id: "operations",
	...
	},
	{
		...
		promptFocus:
			"CRM design, lead scoring, outreach sequences, proposal drafts, and revenue forecasting",
	},
	{
		id: "finance",
		name: "Finance Agent",
		...
		promptFocus:
			"financial modeling, pricing strategy, burn rate analysis, and bookkeeping workflows",
	},
	{
		id: "legal",
		name: "Legal Agent",
		...
		promptFocus:
			"terms of service, privacy policy, contracts, compliance frameworks, and IP protection",
	},
	{
		id: "hr",
		name: "People Agent",
		...
		promptFocus:
			"org structure, hiring plans, onboarding flows, compensation benchmarks, and culture docs",
	},
	{
		id: "product",
		name: "Product Agent",
	...
	},
	{
		...
		promptFocus:
			"tech stack selection, infrastructure, CI/CD, security posture, and scalability planning",
	},
	{
		id: "customer",
		name: "Customer Agent",
		...
		promptFocus:
			"support systems, knowledge base, health scoring, retention strategies, and feedback automation",
	},
] as const;
...
export const SCOPING_PHASES: readonly ScopingPhase[] = [
	{
		...
		name: "Discovery",
		description:
			"Strategy agent interviews the operator, analyzes the idea, and produces the master business blueprint.",
		agents: ["strategy"],
		durationMinutes: 5,
	},
	{
		...
		name: "Architecture",
		description:
			"Product, Tech, and Operations scope what to build, how to build it, and how it runs.",
		agents: ["product", "tech", "operations"],
		durationMinutes: 10,
	},
	{
		phase: 3,
		name: "Revenue Engine",
		description:
			"Marketing, Sales, and Finance design go-to-market, pipeline, pricing, and financial model.",
		agents: ["marketing", "sales", "finance"],
		durationMinutes: 10,
	},
	{
		phase: 4,
		name: "Foundation",
		description:
			"Legal, People, and Customer Success build the org foundation - contracts, hiring, support.",
		agents: ["legal", "hr", "customer"],
		durationMinutes: 8,
	},
	{
		phase: 5,
		name: "Orchestration",
		description:
			"All agents sync outputs into a unified business OS. Gaps are flagged, cross-refs validated.",
		agents: [
			"strategy",
			"operations",
			"marketing",
	...
	for (const phase of SCOPING_PHASES) {
		for (const agentId of phase.agents) {
			...
			agentOutputs.push({
				...
				prompt: getAgentPrompt(agentId, {
					idea,
					phase: phase.phase,
					priorOutputs: priorDeliverables,
				}),
			});
		}
	}
