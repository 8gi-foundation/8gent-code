...
/** Zip multiple arrays together into an array of tuples (stops at shortest). */
...
/** Return elements present in both arrays (no duplicates in output). */
...
/** Return a new array with elements in random order (Fisher-Yates). Does not mutate input. */
