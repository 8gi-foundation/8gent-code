 ...
 * chunks to a consumer callback, accumulates the full response, handles
 * backpressure via a high-water-mark queue, and word-wraps output to a
 * configurable terminal column width.
 */
