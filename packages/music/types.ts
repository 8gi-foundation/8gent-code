...
export const GENRES: Record<
	Genre,
	{ bpmRange: [number, number]; mood: string; layers: LayerRole[] }
> = {
	techno: {
		bpmRange: [125, 140],
		mood: "driving",
		layers: ["drums", "bass", "pad", "fx"],
	},
	house: {
		bpmRange: [118, 130],
		mood: "groovy",
		layers: ["drums", "bass", "melody", "pad"],
	},
	minimal: {
		bpmRange: [120, 130],
		mood: "hypnotic",
		layers: ["drums", "bass", "fx"],
	},
	ambient: {
		bpmRange: [60, 90],
		mood: "atmospheric",
		layers: ["pad", "fx", "melody"],
	},
	"drum-and-bass": {
		bpmRange: [160, 180],
		mood: "intense",
	...
	breakbeat: {
		bpmRange: [120, 140],
		mood: "funky",
		layers: ["drums", "bass", "melody", "fx"],
	},
	trance: {
		bpmRange: [130, 145],
		mood: "euphoric",
		layers: ["drums", "bass", "melody", "pad", "fx"],
	},
	lofi: {
		bpmRange: [70, 90],
		mood: "chill",
		layers: ["drums", "melody", "pad"],
	},
	synthwave: {
		bpmRange: [80, 120],
		mood: "nostalgic",
	...
	dub: {
		bpmRange: [60, 80],
		mood: "spacious",
		layers: ["drums", "bass", "fx", "pad"],
	},
	garage: {
		bpmRange: [128, 135],
		mood: "bouncy",
		layers: ["drums", "bass", "melody", "vocal"],
	},
	jungle: {
		bpmRange: [155, 175],
		mood: "chaotic",
