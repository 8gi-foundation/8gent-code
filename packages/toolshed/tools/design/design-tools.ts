...
registerTool(
	{
		...
		description:
			"Analyze a project's design system: colors, typography, spacing, components, and tokens.",
		capabilities: ["design"],
		inputSchema: {
			type: "object",
			properties: {
...
registerTool(
	{
		...
		description:
			"Generate a React/Vue/Svelte component scaffold with proper patterns for the project's stack.",
		...
		inputSchema: {
			...
			properties: {
				...
				type: {
					type: "string",
					description: "Component type: page, layout, ui, feature, form",
				},
				framework: {
					type: "string",
					description:
