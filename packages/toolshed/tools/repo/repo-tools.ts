...
registerTool(
	{
		name: "file_tree",
		description:
			"Get project file tree. Respects .gitignore and excludes node_modules, .git, dist.",
		capabilities: ["repo"],
		inputSchema: {
			type: "object",
			properties: {
...
registerTool(
	{
		name: "search_code",
		description:
			"Search for a pattern across all files in the repo. Uses ripgrep if available, falls back to grep.",
