...
registerTool(
	{
		name: "get_outline",
		description:
			"Get all symbols in a file without loading full content. Returns functions, classes, types with signatures.",
		...
		inputSchema: {
			...
			properties: {
				...
				kinds: {
					...
					items: { type: "string" },
					description:
						"Filter by symbol kinds (function, class, method, type, interface, constant)",
				},
			},
			required: ["filePath"],
		},
