...
console.log(
	`[smoke-failover] text channel default: ${text.provider}/${text.model}`,
);

// ---- computer channel ----------------------------------------------------
const tier1 = fo.resolve("qwen3.6:27b", "computer");
console.log(
	`[smoke-failover] computer tier 1: ${tier1.provider}/${tier1.model}`,
);
assert(
...
console.log(
	`[smoke-failover] computer tier 2: ${tier2.provider}/${tier2.model}`,
);
assert(
	tier2.provider === "ollama" && tier2.model === "qwen3.6:27b",
	"tier 2 should be Qwen",
);
...
console.log(
	`[smoke-failover] computer tier 3: ${tier3.provider}/${tier3.model}`,
);
...
console.log(
	`[smoke-failover] computer tier 4: ${tier4.provider}/${tier4.model}`,
);
...
console.log(
	`[smoke-failover] computer restored: ${tier2Restored.provider}/${tier2Restored.model}`,
);
assert(
