/**
 * 8gent Code - Design System Suggester
 *
...
const DESIGN_SYSTEMS: Record<string, Omit<DesignSuggestion, "id" | "score">> = {
	"shadcn-tailwind": {
		...
		description: "Clean, modern React components built on Radix UI. Copy-paste components you own.",
		reasoning:
  ...
  ╰─────────────────────────────────╯`,
	...
	"material-ui": {
		name: "Material UI",
		description: "Google's Material Design for React. Comprehensive, enterprise-ready.",
		reasoning:
  ...
  ╰─────────────────────────────────╯`,
		...
		setupSteps: ["Install MUI packages", "Set up theme provider", "Import and use components"],
	},

	"chakra-ui": {
		name: "Chakra UI",
		description: "Simple, modular component library. Excellent developer experience.",
		reasoning:
  ...
  ╰─────────────────────────────────╯`,
		...
		setupSteps: ["Install Chakra packages", "Wrap app in ChakraProvider", "Start using components"],
	},

	"tailwind-custom": {
		name: "Tailwind + Custom",
		description: "Utility-first CSS with your own component designs. Maximum flexibility.",
		reasoning: "Full creative control. Build exactly what you envision. Great for unique designs.",
  ...
  ╰─────────────────────────────────╯`,
	...
	tremor: {
		name: "Tremor",
		description: "Dashboard-first React library. Charts, metrics, and analytics components.",
		reasoning: "Purpose-built for dashboards. Beautiful charts out of the box. KPI cards included.",
  ...
  ╰─────────────────────────────────╯`,
		...
		setupSteps: ["Install Tremor", "Import components", "Build dashboard layouts"],
	},

	"radix-primitives": {
		name: "Radix Primitives",
		description: "Unstyled, accessible UI primitives. Build your design system from scratch.",
		reasoning: "Maximum control for design systems. Headless components you style yourself.",
  ...
  ╰─────────────────────────────────╯`,
		...
		installCommands: ["npm install @radix-ui/react-dialog @radix-ui/react-dropdown-menu"],
		setupSteps: ["Install primitives you need", "Style them your way", "Build your design system"],
	},

	"ant-design": {
		name: "Ant Design",
		description: "Enterprise-grade React UI library. Comprehensive and polished.",
		reasoning: "Chinese enterprise standard. Excellent for data tables, forms, and admin panels.",
  ...
  ╰─────────────────────────────────╯`,
		...
		setupSteps: ["Install Ant Design", "Configure theme if needed", "Use components"],
	},

	"framer-motion": {
		name: "Framer Motion",
		description: "Production-ready animations for React. Gestures, layout, and scroll.",
		reasoning: "Best-in-class animation library. Makes complex animations simple.",
  ...
  ╰─────────────────────────────────╯`,
		...
		setupSteps: ["Install framer-motion", "Import motion components", "Animate everything"],
	},

	"ink-cli": {
		name: "Ink",
		description: "React for CLI apps. Build beautiful terminal interfaces.",
		reasoning: "If you know React, you can build gorgeous CLIs. Full component model.",
  ...
  ╰─────────────────────────────────╯`,
		...
		setupSteps: ["Install Ink and React", "Create CLI component", "Render to terminal"],
	},
};
...
export class DesignSuggester extends EventEmitter {
	...
	async suggest(detection: DetectionResult): Promise<SuggestionResult> {
		...
		const scored = this.scoreDesignSystems(projectType, suggestedCategories, triggers);
		...
		const suggestions: DesignSuggestion[] = filtered.map((item) => ({
			...
			installCommands: this.config.includeSetup
				...
				: undefined,
			setupSteps: this.config.includeSetup ? DESIGN_SYSTEMS[item.id].setupSteps : undefined,
		}));
	...
	private scoreDesignSystems(
		...
		for (const [id, system] of Object.entries(DESIGN_SYSTEMS)) {
			...
			// Category matching
			const categoryMatches = system.category.filter((c) => categories.includes(c)).length;
	 ...
	 */
	private scorePreferences(system: Omit<DesignSuggestion, "id" | "score">): number {
