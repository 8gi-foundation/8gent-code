...
- **Telegram integration.** Bot ([REDACTED-BOT]) with voice transcription, plus an iOS-style Telegram Mini App control panel.
...
- Telegram bot: [REDACTED-BOT] with voice transcription
...
Follow: [X/Twitter](https://x.com/8gentapp) | [GitHub](https://github.com/8gi-foundation/8gent-code) | [8gent.dev](https://8gent.dev)
