...
### Added
- **GitHub Projects playbook** - `docs/process/GITHUB-PROJECTS.md` and `scripts/gh-project-roadmap.sh` for org Project setup, linking `8gent-code`, and bulk-adding epic **#1076** and **#1077–#1093**.
