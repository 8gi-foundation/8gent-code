			...
			correctness: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "(add|subtract|multiply|divide|power|modulo)",
							countMin: 6,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "zero|negative|overflow|NaN|Infinity|precision",
							countMin: 3,
						},
					},
					{
			...
			codeQuality: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "should|when|given|returns|throws",
							countMin: 5,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "llm",
						config: {
							prompt: "Are there redundant tests?",
							scoreThreshold: 70,
						},
					},
				],
			...
			correctness: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "lockout|locked|failed.*attempt|maxFailedAttempts",
							countMin: 2,
						},
					},
					{
			...
			codeQuality: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "resetForTesting|clear|reset|cleanup",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "mock.*time|Date\\.now|setSystemTime|useFakeTimers",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "security|password.*hash|salt|timing|brute.*force",
							countMin: 1,
						},
					},
				],
			...
			correctness: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "\\.once\\s*\\(|once.*handler|single.*fire",
							countMin: 2,
						},
					},
					{
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "AggregateError|error|throw|catch",
							countMin: 2,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "unsubscribe|listenerCount|removeAllListeners|memory",
							countMin: 2,
						},
					},
					{
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "concurrent|parallel|Promise\\.all|multiple.*emit",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "TypedEventEmitter<|interface.*Events|type.*Events",
							countMin: 1,
						},
					},
				],
