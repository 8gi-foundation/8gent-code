...
describe("Financial Calculator", () => {
	...
	it("calculateDebtToEquity returns correct ratio", () => {
		const calcDTE =
			calculator.calculateDebtToEquity ||
			calculator.default?.calculateDebtToEquity;
	...
	it("calculateCurrentRatio returns correct ratio", () => {
		const calcCR =
			...
			calculator.default?.calculateCurrentRatio;
	...
	it("calculateGrossMargin returns correct percentage", () => {
		const calcGM =
			calculator.calculateGrossMargin ||
			calculator.default?.calculateGrossMargin;
	...
	it("calculateNetMargin returns correct percentage", () => {
		const calcNM =
			calculator.calculateNetMargin || calculator.default?.calculateNetMargin;
	...
	it("calculateEBITDA returns correct value", () => {
		const calcEBITDA =
			calculator.calculateEBITDA || calculator.default?.calculateEBITDA;
	...
	it("analyzeFinancials returns object with all ratios", () => {
		const analyze =
			calculator.analyzeFinancials || calculator.default?.analyzeFinancials;
...
describe("Financial Formatter", () => {
	it("formatCurrency formats with commas and dollar sign", () => {
		const fmtCurrency =
			formatter.formatCurrency || formatter.default?.formatCurrency;
	...
	it("formatPercentage formats decimal as percentage", () => {
		const fmtPct =
			formatter.formatPercentage || formatter.default?.formatPercentage;
	...
	it("formatFinancialReport returns string with key sections", () => {
		const fmtReport =
			formatter.formatFinancialReport ||
			formatter.default?.formatFinancialReport;
