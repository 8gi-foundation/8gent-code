/**
 * 8gent Code Benchmarks - React Native / Expo Mobile Development
 *
...
5. Handles empty state gracefully`,
		...
		validators: [
			{
				type: "ast",
				config: { mustContain: ["FlatList", "useAnimatedStyle", "Gesture"] },
			},
		],
		expectedTokens: 1000,
		timeLimit: 150,
		...
		validators: [
			{
				type: "ast",
				config: {
					mustContain: ["useSharedValue", "withSpring", "GestureDetector"],
				},
			},
		],
		expectedTokens: 1200,
