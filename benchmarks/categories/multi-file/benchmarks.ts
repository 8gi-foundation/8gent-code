				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "interface\\s+ApiError|type\\s+ApiError",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "retry|backoff|attempt|maxRetries",
							countMin: 2,
						},
					},
					{
			...
			codeQuality: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: ":\\s*ApiError|as\\s+ApiError|extends\\s+Error",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "\\*\\s*2|Math\\.pow|\\*\\*|exponential",
							countMin: 1,
						},
					},
				],
			...
			correctness: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "useFeatureFlag|useState|useContext",
							countMin: 2,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "interface|type\\s+\\w+|<T>|generic",
							countMin: 5,
						},
					},
					{
						...
						validator: "llm",
						config: {
							prompt: "Is the API design consistent?",
							scoreThreshold: 70,
						},
					},
				],
