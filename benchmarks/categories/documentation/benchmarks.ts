				...
				checks: [
					{
						...
						validator: "llm",
						config: {
							prompt: "Are the JSDoc descriptions accurate?",
							scoreThreshold: 70,
						},
					},
					{
				...
				checks: [
					{
						...
						validator: "llm",
						config: {
							prompt: "Is the documentation concise without being verbose?",
							scoreThreshold: 70,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "@module|@fileoverview|@description[\\s\\S]*API",
							countMin: 1,
						},
					},
				],
			...
			correctness: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "#.*README|Overview|Installation|Quick.*Start",
							countMin: 2,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "```mermaid|stateDiagram|flowchart|graph",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "```typescript|```ts|```js|@example",
							countMin: 3,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "state|transition|guard|action|context|event",
							countMin: 10,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "traffic.*light|form|wizard|loading|auth|toggle",
							countMin: 2,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "llm",
						config: {
							prompt: "Does the doc progress from simple to complex?",
							scoreThreshold: 70,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "API.*Reference|Reference|Methods|Functions",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "best.*practice|recommend|avoid|should|tip",
							countMin: 2,
						},
					},
				],
