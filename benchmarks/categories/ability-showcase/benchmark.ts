...
rather than building from scratch.`,
	...
	rubric: {
		...
		categories: [
			{
				...
				criteria: [
					{
						check: "All 4 replay package files created and functional",
						points: 8,
					},
			...
			},
			{
				...
				criteria: [
					{
						check: "Memory: stored and recalled preferences across steps",
						points: 5,
					},
					{
						check: "Memory: stored schema summary for later reference",
						points: 3,
					},
					{
						check: "Worktree: used parallel branches for data + UI",
						points: 5,
					},
					{ check: "Worktree: merged branches correctly", points: 3 },
					{
						check: "Evolution: adapted approach after finding issues",
						points: 4,
					},
					{
						check: "Healing: checkpointed before modifying existing files",
						points: 4,
					},
					{ check: "Healing: reverted and retried on failure", points: 3 },
					{
						check: "Entrepreneurship: found and reused existing code",
						points: 4,
					},
					{
						check: "AST: analyzed blast radius before modifications",
						points: 4,
					},
		...
		deductions: [
			...
			{
				condition: "Codebase left in broken state (bad imports, syntax errors)",
				points: -20,
			},
			{
				condition: "Used raw <Text> or <Box> in screen components",
				points: -10,
			},
			{
				condition: "Used gray/white/black color props",
				points: -5,
				perOccurrence: true,
			},
			...
			{
				condition: "No worktree usage (all work in single branch)",
				points: -8,
			},
			{
				condition: "No checkpoint before modifying existing files",
				points: -7,
			},
