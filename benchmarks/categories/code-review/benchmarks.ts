				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "plain.*text|password.*storage|hash|bcrypt|argon",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "eval|injection|Function.*construct|code.*execution",
							countMin: 1,
						},
					},
					{
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "auth.*missing|no.*auth|unauth|access.*control",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "Math\\.random|weak.*token|crypto.*random|uuid",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "CORS|origin|wildcard|Access-Control",
							countMin: 1,
						},
					},
				],
			...
			codeQuality: {
				...
				checks: [
					...
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "risk|attack|exploit|malicious|vulnerability",
							countMin: 3,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "critical|high|medium|low|severity|priority",
							countMin: 2,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "best.*practice|recommend|should.*always|never.*trust",
							countMin: 2,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "N\\+1|n\\+1|batch|bulk|one.*query",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "repeat|redundant|memo|cache|compute.*once",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "string.*concat|\\+.*loop|join|array.*push",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "O\\(n\\)|linear|Map|Set|index|lookup",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "memory|leak|unbounded|cache.*size|LRU",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "%|times.*faster|improvement|speedup|reduction",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "priority|impact|important|first|critical",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "god.*function|too.*many|single.*responsibility|SRP",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "magic.*number|hard.*coded|constant|enum",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "nest|pyramid|guard|early.*return|flatten",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "duplicate|DRY|extract|common|reuse",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "parameter.*list|options.*object|builder|config",
							countMin: 1,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "boolean.*flag|separate.*function|polymorphism|strategy",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "```|refactor|improve|extract|split",
							countMin: 4,
						},
					},
					{
						...
						validator: "regex",
						config: {
							pattern: "maintain|test|read|understand|change",
							countMin: 3,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "SOLID|single.*responsibility|open.*closed|interface",
							countMin: 1,
						},
					},
				],
				...
				checks: [
					{
						...
						validator: "regex",
						config: {
							pattern: "pattern|strategy|factory|builder|decorator",
							countMin: 1,
						},
					},
				],
