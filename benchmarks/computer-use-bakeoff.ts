...
import { ModelFailover, type FailoverEntry } from "../packages/providers/failover";
...
function gradeOutput(task: Task, output: string): { pass: boolean; matched: string[]; missed: string[] } {
