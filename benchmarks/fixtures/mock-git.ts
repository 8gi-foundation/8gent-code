...
const FILE_TREE: Record<string, MockDirEntry[]> = {
	...
	"/repos/api-server/vendor": [{ name: "lib", isDirectory: true }],
	"/repos/api-server/vendor/lib": [
		{ name: ".git", isDirectory: true }, // submodule!
		{ name: "lib.go", isDirectory: false },
	],
	"/repos/api-server/vendor/lib/.git": [{ name: "HEAD", isDirectory: false }],
	"/repos/empty-project": [{ name: ".git", isDirectory: true }],
	"/repos/empty-project/.git": [{ name: "HEAD", isDirectory: false }],
	"/repos/legacy": [
		{ name: ".git", isDirectory: true },
	...
	"/repos/legacy/.git": [{ name: "HEAD", isDirectory: false }],
};

const FILE_STATS: Record<string, MockStat> = {
	"/repos/readme.txt": { isDirectory: false, isFile: true, size: 256 },
	"/repos/webapp/package.json": {
		isDirectory: false,
		isFile: true,
		size: 1024,
	},
	"/repos/webapp/tsconfig.json": {
		isDirectory: false,
		isFile: true,
		size: 512,
	},
	"/repos/webapp/src/index.ts": {
		isDirectory: false,
		isFile: true,
		size: 2048,
	},
	"/repos/webapp/src/app.tsx": { isDirectory: false, isFile: true, size: 8192 },
	"/repos/webapp/src/utils.ts": {
		isDirectory: false,
		isFile: true,
		size: 4096,
	},
	"/repos/webapp/src/styles.css": {
		isDirectory: false,
		isFile: true,
		size: 3072,
	},
	...
	"/repos/api-server/cmd/main.go": {
		isDirectory: false,
		isFile: true,
		size: 1024,
	},
	"/repos/api-server/cmd/server.go": {
		isDirectory: false,
		isFile: true,
		size: 6144,
	},
	"/repos/api-server/internal/handler.go": {
		isDirectory: false,
		isFile: true,
		size: 12288,
	},
	"/repos/api-server/internal/middleware.go": {
		isDirectory: false,
		isFile: true,
		size: 4096,
	},
	"/repos/api-server/internal/models.go": {
		isDirectory: false,
		isFile: true,
		size: 3072,
	},
	"/repos/api-server/vendor/lib/lib.go": {
		isDirectory: false,
		isFile: true,
		size: 2048,
	},
