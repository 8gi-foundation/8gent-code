...
function SectionTwo() {
	return (
		<div>
			...
			<p className="mb-4">
				8gent is an autonomous AI coding agent that empowers developers through local-first, agentic
				intelligence.
			</p>
		</div>
	);
	...
	return (
		<div>
			...
			<div className="bg-white rounded-lg p-6 shadow">
				...
				<p className="mb-4">
					To liberate developers from usage caps, subscription fatigue, and cloud dependency by
					providing a truly autonomous, local-first AI coding agent that puts control back in the
					hands of builders.
				</p>
				...
				<p className="mb-4">
					We provide an autonomous coding agent that understands and navigates codebases
					intelligently, executes complex coding tasks with minimal supervision, learns and improves
					through autoresearch and benchmarking, provides a rich TUI experience with animations,
					voice, and intelligent features, integrates with local LLMs for private, unlimited usage,
					and follows structured methodologies (BMAD) for reliable outcomes.
				</p>
			</div>
		</div>
	);
		...
		<div>
			...
			<div className="bg-white rounded-lg p-6 shadow">
				...
				<ol className="list-decimal list-inside space-y-2 mb-4">
					<li>
						Autonomy: We believe in giving developers complete control over their tools and data.
						8gent runs locally, ensuring privacy and freedom from usage caps.
					</li>
					<li>
						Craftsmanship: We take pride in elegant, efficient code and thoughtful user experiences.
						Every aspect of 8gent is crafted with attention to detail.
					</li>
					<li>
						Empowerment: Our goal is to amplify developer capabilities, not replace them. We provide
						intelligent assistance that enhances human creativity and problem-solving.
					</li>
					<li>
						Playful Sophistication: As the Infinite Gentleman, we balance wit and wisdom. We're
						sophisticated without being stuffy, professional without losing our sense of fun.
					</li>
					<li>
						Continuous Improvement: Through autoresearch and benchmarking, we constantly evolve. We
						believe in learning from our experiences and improving iteratively.
					</li>
					<li>
						Community & Openness: We embrace open source principles (MIT license) and believe in
						sharing knowledge. Our strength comes from community collaboration.
					</li>
					<li>
						Local-First Philosophy: We prioritize local execution to ensure data privacy, offline
						capability, and independence from external service limitations.
					</li>
				</ol>
		...
		<div>
			...
			<div className="bg-white rounded-lg p-6 shadow">
				...
				<ul className="list-disc list-inside space-y-2 mb-4">
					...
					<li>
						Helpful without being sycophantic - no &ldquo;certainly!&rdquo; or &ldquo;of
						course!&rdquo;
					</li>
				</ul>
				<h3 className="text-xl font-semibold mb-2">Voice Characteristics</h3>
				<p className="mb-4">
					Uses TTS voice output via macOS `say` command (Daniel voice, British). Every task
					completion is spoken aloud automatically. Ends tasks with: 🎯 COMPLETED: &lt;witty summary
					in 25 words max&gt;.
				</p>
				<h3 className="text-xl font-semibold mb-2">Example Utterances</h3>
				<ul className="list-disc list-inside space-y-2">
					<li>
						&ldquo;🎯 COMPLETED: Another masterpiece. Fixed the auth bug, pushed to main. Why did
		...
		<div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				<div className="bg-white rounded-lg p-6 shadow">
					...
					<p className="mb-4">
						A stylized monogram combining the infinity symbol (∞) with a gentleman's top hat or
			...
			<div className="bg-white rounded-lg p-6 shadow">
				...
				<div className="mt-4 p-4 bg-gray-50 rounded">
					...
					<p className="font-mono text-sm mt-1">
						🎯 COMPLETED: Another masterpiece. Examined 47 packages, 12 apps, and discovered the
						debugger web UI. Why do programmers prefer dark mode? Because light attracts bugs.
					</p>
				</div>
			</div>
		</div>
	...
	return (
		<div>
			...
			<div className="bg-white rounded-lg p-6 shadow">
				...
				<p className="mb-4">
					A Next.js application for viewing and interacting with debugging sessions:
				</p>
				<ul className="list-disc list-inside space-y-2">
		...
		<div>
			...
			<div className="space-y-6">
				<div className="bg-white rounded-lg p-6 shadow">
					...
					<ul className="list-disc list-inside space-y-1">
						...
						<li>
							Sticker sheet: &ldquo;Privacy isn't a feature&rdquo;, &ldquo;Local First&rdquo;,
							&ldquo;The Infinite Gentleman&rdquo;
						</li>
				...
				<div className="bg-white rounded-lg p-6 shadow">
					...
					<ol className="list-decimal list-inside space-y-1">
						...
						<li>
							First task: &ldquo;Show me your capabilities&rdquo; → agent creates a simple TODO app
						</li>
						<li>
							Completion: &ldquo;🎯 COMPLETED: Your first app is ready. Remember: the best code is
							written with a cup of tea and a clear mind.&rdquo;
						</li>
					</ol>
				</div>
				<div className="bg-white rounded-lg p-6 shadow">
					...
					<ul className="list-disc list-inside space-y-1">
						...
						<li>
							Limited edition: &ldquo;BMAD Master&rdquo; series (for completing 10 autonomous tasks)
						</li>
			...
			<div className="mt-8 pt-6 border-t">
				...
				<ul className="list-disc list-inside space-y-2">
					...
					<li>
						<strong>Short-term:</strong> Launch merch store, enhance TUI with more voice
						interactions
					</li>
					<li>
