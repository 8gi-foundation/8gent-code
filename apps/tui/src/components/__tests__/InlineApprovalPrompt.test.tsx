...
const LONG_TARGET =
	"write /Users/jamesspalding/8gent-code/apps/tui/src/components/very/deeply/nested/path/to/file/that/will/definitely/exceed/the/visible/width/of/the/inline/approval/card.ts";
