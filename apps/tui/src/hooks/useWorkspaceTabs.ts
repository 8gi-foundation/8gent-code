  ...
  return [
    {
      ...
      lastAccessedAt: now,
      pinned: true,
      data: { modelOverride: { provider: "apfel", model: "apple-foundationmodel" } },
    },
    {
      id: "tab-gemma4",
      type: "chat",
      ...
      lastAccessedAt: now,
      pinned: true,
      data: { modelOverride: { provider: "lmstudio", model: "auto" } },
    },
    {
      id: "tab-qwen32b",
      type: "chat",
      ...
      lastAccessedAt: now,
      pinned: true,
      data: { modelOverride: { provider: "ollama", model: "qwen3:32b" } },
    },
    {
      id: "tab-notes",
      type: "notes",
